...
import (
	...
	algorithm "go.osspkg.com/goppy/v3/plugins/auth/token/algorithm"
)
...
func easyjson6601e8cdDecodeGoOsspkgComGoppyV3PluginsAuthToken(in *jlexer.Lexer, out *Header) {
...
func easyjson6601e8cdEncodeGoOsspkgComGoppyV3PluginsAuthToken(out *jwriter.Writer, in Header) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Header) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6601e8cdEncodeGoOsspkgComGoppyV3PluginsAuthToken(&w, v)
...
func (v *Header) UnmarshalJSON(data []byte) error {
	...
	easyjson6601e8cdDecodeGoOsspkgComGoppyV3PluginsAuthToken(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Header) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6601e8cdDecodeGoOsspkgComGoppyV3PluginsAuthToken(l, v)
}
