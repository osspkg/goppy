...
func (BYTES) Encode(w io.Writer, in any) (string, error) {
	...
	case []byte:
		...
		return mime.DetectByContent(data), nil
	...
	case io.Reader:
		...
		if _, err := data.Read(sniff); err != nil {
			return "", err
		}
		...
		return mime.DetectByContent(sniff), nil
	...
	case encoding.TextMarshaler:
		...
		return mime.DetectByContent(b), nil
	...
	case bytesGetter:
		...
		return mime.DetectByContent(data.Bytes()), nil
