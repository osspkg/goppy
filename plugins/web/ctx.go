...
func (v *_ctx) BindRaw() (*bb.Buffer, error) {
	defer func() {
...
func (v *_ctx) BindFormData(maxMemory int64, in any) error {
	...
	return encoders.FormDataDecode(v.r.Body, maxMemory, in)
}
...
func (v *_ctx) Raw(code int, contentType string, b []byte) {
	encoders.RawEncode(v.w, code, contentType, b)
}
